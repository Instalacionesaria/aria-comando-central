---
name: market-research-paso-1
description: Paso 1 del Market Research secuencial: encuentra 3-4 segmentos de mercado B2B dentro del nicho que cumplan los criterios de compradores potenciales, LTV y contrato inicial. Los outputs previos llegan como _prev.N; no alterar la cadena secuencial.
version: 1.0.0
metadata:
  author: ARIA IA
---
...
Quiero que sus clientes tengan un LTV mayor a {{ltv}}.
{{#contract}}Quiero que el valor de contrato inicial sea mayor a {{contract}}.{{/contract}}
